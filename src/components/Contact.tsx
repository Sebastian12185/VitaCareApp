...
export function Contact() {
  ...
  return (
    <section
      id="contact-section"
      className="px-6 py-16 border-t border-slate-100"
    >
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full p-4 border border-slate-200 rounded-xl focus:outline-none focus:border-brand-blue"
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-4 border border-slate-200 rounded-xl resize-none focus:outline-none focus:border-brand-blue"
                />
              ...
              <button
                ...
                className="mt-2 bg-brand-blue hover:bg-brand-dark text-white font-bold py-4 rounded-xl transition-all"
              >
